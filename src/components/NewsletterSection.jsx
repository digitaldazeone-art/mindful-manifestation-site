  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || `The server responded with an error. Please try again.`);
      }
      ...
      toast({
        ...
        description: error.message || "Failed to send the ebook. Please check your connection and try again.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
